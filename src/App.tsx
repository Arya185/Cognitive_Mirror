...
export default function App() {
  ...
  const [activePersonaFilter, setActivePersonaFilter] = useState<
    PersonaId | "all"
  >("all");
  ...
  const handleEvaluate = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error || "Failed to evaluate writing sample.",
        );
      }
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center space-y-3 pt-4">
              ...
              <p className="text-sm sm:text-base text-slate-500 max-w-2xl mx-auto leading-relaxed font-sans font-medium">
                Evaluates clarity, craft, logical scrutiny, and raw felt emotion
                across four non-overlapping reader heuristics.
              </p>
            </div>
